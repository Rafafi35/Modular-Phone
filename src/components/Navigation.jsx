  ...
  return (
    <nav className="sticky top-0 left-0 w-full bg-white border-b-2 border-gray-200">
      <div className="flex font-bold justify-center">
        <NavLink to="/Modular-Phone/" end className={linkStyle}>
          <House size={18} />
          Home
        </NavLink>

        <NavLink to="/Modular-Phone/configure" end className={linkStyle}>
          <Wrench size={18} />
          Configure
        </NavLink>

        <NavLink to="/Modular-Phone/buy-parts" end className={linkStyle}>
          <Component size={18} />
          Buy Parts
        </NavLink>

        <NavLink to="/Modular-Phone/community" end className={linkStyle}>
            <Smile size={18} />
            Community
        </NavLink>

        <NavLink to="/Modular-Phone/cart" end className={linkStyle}>
